...
public class ObjectDefinitions {
	...
	public static void main(String[] args) throws IOException { {
		Cache.init();
		ObjectDefinitions defs = getObjectDefinitions(33000);
		System.out.println(defs.objectAnimation);
	
	}
		
		for (int i = 0; i <= 33000; i++) {
			ObjectDefinitions defs = getObjectDefinitions(i);// got it? 
			if(defs.objectAnimation != -1) {
				System.out.println(i + " - " + defs.objectAnimation + " - " + defs.name);
			}
		}
	}
