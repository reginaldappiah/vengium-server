...
public class BonesOnAltar extends Action {
	...
	public enum Bones {
		BONES(new Item(526, 1), 5), BURNT_BONES(new Item(528, 1), 5), WOLF_BONES(new Item(2859, 1), 5), MONKEY_BONES(new Item(3183, 1), 5), BAT_BONES(new Item(530, 1), 5), BIG_BONES(new Item(532, 1), 15), JOGRE_BONES(new Item(3125, 1), 15), ZOGRE_BONES(new Item(4812, 1), 23), BABYDRAGON_BONES(new Item(534, 1), 30), WYVERN_BONES(new Item(6812, 1), 50), DRAGON_BONES(new Item(536, 1), 72), FAYRG_BONES(new Item(4830, 1), 84), RAURG_BONES(new Item(4832, 1), 96), OURG_BONES(new Item(4834, 1), 140), FROST_DRAGON_BONES(new Item(18830, 1), 180), DAGANNOTH_BONES(new Item(6729, 1), 125);
