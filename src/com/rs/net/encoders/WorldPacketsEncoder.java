...
public class WorldPacketsEncoder extends Encoder {
    ...
    public void sendPanelBoxMessage(String text) {
        sendMessage(player.getRights() == 4 ? 99 : 0, text, null);
    }
    ...
    public void sendTeleportRequestMessage(Player p) {
        sendMessage(101, "wishes to teleport to you.", p);
    }
     ...
     *
     * @param area = area which will be blackout (0 = unblackout; 1 =
