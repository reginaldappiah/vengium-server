...
public final class Utils {
    ...
    //public static final int getRSMVFaceDirection() {
    ...
    public static boolean invalidTriviaAnswer(String answer) {
        return answer.length() < 2 || answer.length() > 25 || answer.startsWith("_") || answer.endsWith("_") || answer.contains("__") || containsInvalidCharacter(answer);
    }
    ...
    public static String fixChatMessage(String message) {
        ...
        for (int i = 0; i < message.length(); i++) {
            if (wasSpace) {
                ...
                if (!String.valueOf(message.charAt(i)).equals(" "))//If the message doesn't have a space
                    wasSpace = false;//It has no capitalizing
            } else
