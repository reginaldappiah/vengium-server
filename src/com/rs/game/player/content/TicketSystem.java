...
public class TicketSystem {
	...
	public static void answerTicket(Player player) {
		...
		filterTickets();
		if (tickets.isEmpty()) {
			player.sm("There are currently no tickets available. Keep it up!");
			return;
