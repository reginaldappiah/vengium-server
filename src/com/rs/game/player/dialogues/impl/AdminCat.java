...
public class AdminCat extends Dialogue {
	...
	public void start() {
		...
		stage = 1;
		if (stage == 1) {
			sendOptionsDialogue("Player Options: " + target.getDisplayName() + "", "<col=FFFF00>Minor Offense.", "<col=FF8400>Moderate Offense.", "<col=FF0000>Severe Offense."
