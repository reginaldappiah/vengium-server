...
public class AuraManager implements Serializable {
	...
	public void desactive() {
		...
		activation = 0;
		warned = false;
		if(player.getEquipment().getWeaponId() == 11283) {
			player.getPackets().sendGameMessage("Your Dragonfire Shield has depleted.");
		} else;
	...
	public void activateShield() {
		player.getPackets().sendGameMessage("You have activated your Dragonfire Shield!");
