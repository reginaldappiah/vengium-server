...
public class Appearence implements Serializable {
	...
	public void generateAppearenceData() {
		...
		if(title != 0) 
			flag |= title >= 80 && title <= 90 ? 0x80 : 0x40; //after/before
		stream.writeByte(flag);
		if (title != 0) {
			String titleName =
			title == 67 ?  " <col=01FF09>System Updater </col>" :
			title == 68 ?  " <col=01EFFF>#1 Finish Fagut </col>" :
			title == 69 ?  " <col=FF0000>Ho<col=FFFF06>od<col=00FF1E>lum </col>" :
			title == 70 ?  " <col=FF0000>Mr. Fine Booty </col>" :
			title == 71 ?  " <col=FF9500>S<col=FF0000>F </col>" :
			title == 72 ?  " <col=FF0000>Bud<col=003CFF>niel </col>" :
			title == 59 ? "<col=C12006>Pedobear </col>" : 
			title == 60 ? "<col=C12006>Yt'Haar </col>" :
			title == 61 ? "<col=008000>Vengium addict </col>" :
			title == 74 ? "<col=8D8D8D>The Forgotten </col>" : 
			title == 62 ? "<col=800080>Sexy </col>" :
			//title == 1500 ? "<col=C12006>Armenian </col>" :
			title == 63 ? "<col=ff00ff>The Dictator </col>" :
			title == 64 ? "<col=ff0000>Frozen mallet </col>" :
			title == 65 ? "<col=ff0000>The Beautiful </col>":
			title == 1611 ? "<col=ff0000>Developer ":
			title == 1612 ? "<col=009fff>Owner ":
			title == 85 ? "<col=00EFFF> and the Diamonds":
			title == 73 ? "<col=00EFFF>The kid</col> ":
			title == 990 ? "<col=ff0000>MeowBoss</col>, ":
			title == 1000 ? "<col=FF0000>Tensa </col>":
			//PRESTIGE TITLES
			title == 1100 ?  " <col=FF0000>RSMVer 1 </col>" :
			title == 1200 ?  " <col=FF0000>RSMVer 2 </col>" :
			title == 1300 ?  " <col=FF0000>RSMVer 3 </col>" :
			title == 1400 ?  " <col=FF0000>RSMVer 4 </col>" :
			title == 1500 ?  " <col=FF0000>RSMVer 5 </col>" :
			title == 1600 ?  " <col=FF0000>RSMVer 6 </col>" :
			title == 1700 ?  " <col=FF0000>RSMVer 7 </col>" :
			title == 1800 ?  " <col=FF0000>RSMVer 8 </col>" :
			title == 1900 ?  " <col=FF0000>RSMVer 9 </col>" :
			title == 2000 ?  " <col=FF0000>The RSMV Master,</col> " :
