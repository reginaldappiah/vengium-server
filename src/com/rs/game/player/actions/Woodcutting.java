...
public final class Woodcutting extends Action {
    ...
    public static enum TreeDefinitions {
    		...
    		HWEEN(75, 15, 29931, 3, 1, -1, 94, 100),

    		XMAS(40, 15, 29924, 3, 1, -1, 94, 100),

    		NORMAL(1, 25, 1511, 20, 4, 1341, 8, 0), // TODO
    		
    		SWAMP(1, 25, 1511, 20, 4,  58143, 8, 0),
    		
    		HOLLOW1(45, 82.5, 3239, 20, 4, 2291, 8, 0),
    
    		HOLLOW2(45, 82.5, 3239, 20, 4, 4061, 8, 0),
    		...
    		TEAK(35, 75, 6333, 85, 10, 9037, 60, 10),

    		MAPLE(45, 100, 1517, 83, 16, 31057, 72, 10),

    		YEW(60, 175, 1515, 120, 17, 1341, 94, 10), // TODO

    		MAHOGANY(50, 130, 6332, 100, 30, 70079, 80, 10),

    		ARCTIC_PINE(54, 150, 10810, 60, 5, 70059, 87, 10),

    		EUCALYPTUS(58, 140, 12581, 100, 14, 70067, 90, 10),

    		IVY(68, 332.5, -1, 120, 17, 46319, 58, 10),

    		MAGIC(75, 250, 1513, 150, 21, 37824, 121, 10),

    		BLOODWOOD(85, 320, 24121, 150, 21, 4136, 3600, 50),
	...
	return World.containsObjectWithId(tree, tree.getId());//this is better one
    }
