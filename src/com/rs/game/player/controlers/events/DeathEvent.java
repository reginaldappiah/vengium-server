...
public class DeathEvent extends Controler {
	...
	public static final WorldTile RESPAWN = new WorldTile(2596, 3409, 0);
	...
	public boolean logout() {
		player.setLocation(new WorldTile(2596, 3409, 0));
		destroyRoom();
		return false;
	}
	...
	public void sendInterfaces() {
		...
		player.getInterfaceManager().closeTicketSystem();
	...
	public void magicTeleported(int type) {
		...
		player.getInterfaceManager().sendTicketSystem();
