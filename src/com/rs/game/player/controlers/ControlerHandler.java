...
//			handledControlers.put("DungeonControler", value99);
			...
			handledControlers.put("HouseCon", (Class<Controler>) Class.forName(HouseCon.class.getCanonicalName()));
			handledControlers.put("ConstructionControler", (Class<Controler>) Class.forName(HouseCon.class.getCanonicalName()));
		} catch (Throwable e) {
			Logger.handle(e);
		}
	}
